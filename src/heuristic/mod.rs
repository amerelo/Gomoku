...
pub fn value_slot(map: &Map, (y, x, _):(i128, i128, i128)) -> i128
{
    ...
    // count += match x
    // {
    //     17 => slot_cmp![map.value[y as usize], (RSIZEMAP - x) * 3 ; MOVE_P2; [0, 3, 6]] as usize,
    //     16 => slot_cmp![map.value[y as usize], (RSIZEMAP - x) * 3 ; MOVE_P2; [0, 1, 3, 4]] as usize,
    //     15 => slot_cmp![map.value[y as usize], (RSIZEMAP - x) * 3 ; MOVE_P2; [0, 1, 2, 3, 4, 7]] as usize,
    //     _  => slot_cmp![map.value[y as usize], (RSIZEMAP - x) * 3 ; MOVE_P2; [0, 1, 2, 3, 4, 5, 7, 8]] as usize
    // };

    // count += match y
    // {
    //     1 => slot_cmp![map.value_rotate[x as usize], y * 3 ; MOVE_P2; [0, 3, 6]] as usize,
    //     2 => slot_cmp![map.value_rotate[x as usize], y * 3 ; MOVE_P2; [0, 1, 3, 4]] as usize,
    //     3 => slot_cmp![map.value_rotate[x as usize], y * 3 ; MOVE_P2; [0, 1, 2, 3, 4, 7]] as usize,
    //     _ => slot_cmp![map.value_rotate[x as usize], y * 3 ; MOVE_P2; [0, 1, 2, 3, 4, 5, 7, 8]] as usize
    // };
