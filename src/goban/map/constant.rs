...
pub const MOVE_P1: [(i128, i128, i128, i128); 35] = [
...
pub const MOVE_P2: [(i128, i128, i128, i128); 35] = [
                            ...
                            /*25 00*/        (0o33333, 0o22220, 0, ENEMY_FIVE_ALIGN), // 2222X
                            /*26 01*/        (0o33333, 0o22202, 3, ENEMY_FIVE_ALIGN), // 222X2
                            /*27 02*/        (0o33333, 0o22022, 6, ENEMY_FIVE_ALIGN), // 22X22
                            /*28 03*/        (0o33333, 0o20222, 9, ENEMY_FIVE_ALIGN), // 2X222
                            /*29 04*/        (0o33333, 0o02222, 12, ENEMY_FIVE_ALIGN),// X2222
                            /*30 00*/        (0o33333, 0o11110, 0, FIVE_ALIGN),       // 1111X
                            /*31 01*/        (0o33333, 0o11101, 3, FIVE_ALIGN),       // 111X1
                            /*32 02*/        (0o33333, 0o11011, 6, FIVE_ALIGN),       // 11X11
                            /*33 03*/        (0o33333, 0o10111, 9, FIVE_ALIGN),       // 1X111
                            /*34 04*/        (0o33333, 0o01111, 12, FIVE_ALIGN),      // X1111

                                            ];

pub const DMOVE_P1: [(i128, i128, i128, i128); 35] = [
                            /*00 00*/        (0o3333333, 0o0010100, 0, THREE_ALIGN),          // ||.'1'1'X
                            /*01 02*/        (0o3333333, 0o0010001, 6, THREE_ALIGN),          // ||.'1'X'1
                            /*02 04*/        (0o3333333, 0o0000101, 12, THREE_ALIGN),         // ||.'X'1'1
                            ...
                            /*16 03*/        (0o3333333, 0o2000202, 9, ENEMY_THREE_ALIGN),    // |2'X'2'2
...
pub const DMOVE_P2: [(i128, i128, i128, i128); 35] = [
                            ...
                            /*16 03*/        (0o3333333, 0o1000101, 9, ENEMY_THREE_ALIGN),    // |1'X'1'1
                            ...
                            /*25 00*/        (0o333333333, 0o202020200, 0, ENEMY_FIVE_ALIGN), // 2'2'2'2'X
                            /*26 02*/        (0o333333333, 0o202020002, 6, ENEMY_FIVE_ALIGN), // 2'2'2'X'2
                            /*27 04*/        (0o333333333, 0o202000202, 12, ENEMY_FIVE_ALIGN), // 2'2'X'2'2
                            /*28 06*/        (0o333333333, 0o200020202, 18, ENEMY_FIVE_ALIGN), // 2'X'2'2'2
                            /*29 08*/        (0o333333333, 0o002020202, 24, ENEMY_FIVE_ALIGN),// X'2'2'2'2
                            /*30 00*/        (0o333333333, 0o101010100, 0, FIVE_ALIGN),       // 1'1'1'1'X
                            /*31 02*/        (0o333333333, 0o101010001, 6, FIVE_ALIGN),       // 1'1'1'X'1
                            /*32 04*/        (0o333333333, 0o101000101, 12, FIVE_ALIGN),       // 1'1'X'1'1
                            /*33 06*/        (0o333333333, 0o100010101, 18, FIVE_ALIGN),       // 1'X'1'1'1
                            /*34 08*/        (0o333333333, 0o001010101, 24, FIVE_ALIGN),      // X'1'1'1'1
